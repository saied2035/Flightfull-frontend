...
export const fetchReservations = (userId) => (dispatch) => {
  ...
  return fetch(`https://flightfull-production-43d5.up.railway.app/api/v1/users/${userId}/reservations`)
...
export const createReservation = (data) => (dispatch) => (
  fetch(`https://flightfull-production-43d5.up.railway.app/api/v1/users/${data.user_id}/reservations`, {
    method: 'POST',
    headers: {
...
export const deleteReservation = (data) => (dispatch) => (
  fetch(`https://flightfull-production-43d5.up.railway.app/api/v1/users/${data.user_id}/reservations/${data.id}`, {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json',
    },
